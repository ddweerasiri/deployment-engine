...
/**
 * User: denis
 * PivotalTracker Connector
 */
public class PivotalTrackerConnector implements CloudResourceDeploymentConnector {
    private static final Logger log = LoggerFactory.getLogger(PivotalTrackerConnector.class);
