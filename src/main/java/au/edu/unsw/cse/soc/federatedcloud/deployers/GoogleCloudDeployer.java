...
/**
 * User: denis
 * GoogleCloud Deployer
 */
public class GoogleCloudDeployer implements CloudResourceDeployer {
    private static final Logger log = LoggerFactory.getLogger(GoogleCloudDeployer.class);
